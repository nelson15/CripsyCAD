...
set (OpenCASCADE_C_FLAGS_RELEASE      "-DNDEBUG -DNo_Exception")
set (OpenCASCADE_CXX_FLAGS_RELEASE    "-DNDEBUG -DNo_Exception")
...
set_property(DIRECTORY APPEND PROPERTY COMPILE_DEFINITIONS $<$<CONFIG:Release>:HAVE_GL2PS>)
