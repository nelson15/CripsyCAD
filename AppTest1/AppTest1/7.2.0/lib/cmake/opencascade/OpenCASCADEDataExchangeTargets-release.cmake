...
set_target_properties(TKXSBase PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXSBase.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKXSBase.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKXSBase )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKXSBase "${_IMPORT_PREFIX}/lib/libTKXSBase.7.2.0.dylib" )
...
set_target_properties(TKSTEPBase PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKSTEPBase.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKSTEPBase.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKSTEPBase )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKSTEPBase "${_IMPORT_PREFIX}/lib/libTKSTEPBase.7.2.0.dylib" )
...
set_target_properties(TKSTEPAttr PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKSTEPAttr.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKSTEPAttr.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKSTEPAttr )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKSTEPAttr "${_IMPORT_PREFIX}/lib/libTKSTEPAttr.7.2.0.dylib" )
...
set_target_properties(TKSTEP209 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKSTEP209.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKSTEP209.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKSTEP209 )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKSTEP209 "${_IMPORT_PREFIX}/lib/libTKSTEP209.7.2.0.dylib" )
...
set_target_properties(TKSTEP PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKSTEP.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKSTEP.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKSTEP )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKSTEP "${_IMPORT_PREFIX}/lib/libTKSTEP.7.2.0.dylib" )
...
set_target_properties(TKIGES PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKIGES.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKIGES.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKIGES )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKIGES "${_IMPORT_PREFIX}/lib/libTKIGES.7.2.0.dylib" )
...
set_target_properties(TKXCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXCAF.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKXCAF.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKXCAF )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKXCAF "${_IMPORT_PREFIX}/lib/libTKXCAF.7.2.0.dylib" )
...
set_target_properties(TKXDEIGES PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXDEIGES.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKXDEIGES.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKXDEIGES )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKXDEIGES "${_IMPORT_PREFIX}/lib/libTKXDEIGES.7.2.0.dylib" )
...
set_target_properties(TKXDESTEP PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXDESTEP.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKXDESTEP.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKXDESTEP )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKXDESTEP "${_IMPORT_PREFIX}/lib/libTKXDESTEP.7.2.0.dylib" )
...
set_target_properties(TKSTL PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKSTL.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKSTL.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKSTL )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKSTL "${_IMPORT_PREFIX}/lib/libTKSTL.7.2.0.dylib" )
...
set_target_properties(TKVRML PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKVRML.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKVRML.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKVRML )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKVRML "${_IMPORT_PREFIX}/lib/libTKVRML.7.2.0.dylib" )
...
set_target_properties(TKXmlXCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKXmlXCAF.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKXmlXCAF.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKXmlXCAF )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKXmlXCAF "${_IMPORT_PREFIX}/lib/libTKXmlXCAF.7.2.0.dylib" )
...
set_target_properties(TKBinXCAF PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKBinXCAF.7.2.0.dylib"
  IMPORTED_SONAME_RELEASE "libTKBinXCAF.7.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS TKBinXCAF )
list(APPEND _IMPORT_CHECK_FILES_FOR_TKBinXCAF "${_IMPORT_PREFIX}/lib/libTKBinXCAF.7.2.0.dylib" )
